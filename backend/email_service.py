...
class EmailService:
    ...
    async def send_purchase_confirmation(
            ...
            <div class="container">
                ...
                <div class="content">
                    ...
                    <div style="text-align: center;">
                        <a href="https://bulk-message-hub-2.preview.emergentagent.com/login" class="button">
                            Acessar Plataforma
                        </a>
                    </div>
        ...
        Acesse: https://bulk-message-hub-2.preview.emergentagent.com/login
    ...
    async def send_campaign_completed(
        ...
        <body>
            <div class="container">
                ...
                <div class="content">
                    ...
                    <div style="text-align: center;">
                        <a href="https://bulk-message-hub-2.preview.emergentagent.com/disparador" class="button">
        ...
        Acesse: https://bulk-message-hub-2.preview.emergentagent.com/disparador
