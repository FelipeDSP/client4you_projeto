...
**Base URL:** `https://client-bugfix.preview.emergentagent.com/api`
...
VITE_BACKEND_URL=https://client-bugfix.preview.emergentagent.com
```
...
curl https://client-bugfix.preview.emergentagent.com/api/
```
